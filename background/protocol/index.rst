...
.. warning::
    ...
    There are also several cases where the parameters listed have a value and no further explanation.  If the behaviour is unknown, these may just be copied from requests made by Skype for Web, and have been replicated in SkPy too.
